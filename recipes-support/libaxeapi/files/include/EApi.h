...
EAPI_CALLTYPE
EApiCanSetEnable(
    __IN  ax_eapi_arm_id_t  Id      , /* Value Id */
    __IN  uint32_t CanEnable,      /* CanEnable */
    __IN  uint32_t CanBitrate     /* CanBitrate */
);
...
EApiCanGetTermination(
    __IN  ax_eapi_arm_id_t  Id      , /* Value Id */
    __OUT  uint32_t* type      /* COM Port Capability and Control */
);
...
EApiCanSetTermination(
    __IN  ax_eapi_arm_id_t  Id      , /* Value Id */
    __IN  uint32_t type      /* COM Port Capability and Control */
);
...
EApiComGetTermination(
    __IN  ax_eapi_arm_id_t  Id      , /* Value Id */
    __OUT  uint32_t* enable      /* COM Port Capability and Control */
);
...
EApiComSetTermination(
    __IN  ax_eapi_arm_id_t  Id      , /* Value Id */
    __IN  uint32_t enable      /* COM Port Capability and Control */
);

/*
 * EApiBoardSetValueWithIndex
 *
 * Condition                              | Return Values
 * ---------------------------------------+------------------------------
 * Library Uninitialized                  | EAPI_STATUS_NOT_INITIALIZED
...
EApiBoardSetValueWithIndex(
    __IN  ax_eapi_arm_id_t  Id      , /* Value Id */
    __IN  uint32_t Index    , /* Value Index */
